 ...
 */
package com.mch.generate.core.util;

import com.mch.core.consts.CommonConstant;
import com.mch.core.enums.DbIdEnum;
...
public class Util {
    ...
    private static int getIndex(String string, int i, String str) {
        Matcher slashMatcher = Pattern.compile(str).matcher(string);        int mIdx = 0;
    ...
    public static void main(String[] args) {
        String aaa = "fjw2qqw2dhsfjdsbfjhdsg343hfjdgsfw2";
        System.out.println(getIndex(aaa, 2, "w2"));
