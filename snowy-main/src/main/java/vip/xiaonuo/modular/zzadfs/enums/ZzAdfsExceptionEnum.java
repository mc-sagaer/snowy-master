 ...
 */
package vip.xiaonuo.modular.zzadfs.enums;
...
public enum ZzAdfsExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        ZzAdfsExceptionEnum(Integer code, String message) {
        this.code = code;
